...
class FiqhSectionPage extends StatefulWidget {
  ...
  const FiqhSectionPage({super.key, required this.isDarkMode, this.toggleTheme});
  ...
  void initState() {
    ...
    Future.microtask(() {
      Provider.of<SubcategoryProvider>(context, listen: false)
          .loadSubcategoriesBySection('الفقه');
    });
  }
    ...
    return Scaffold(
      ...
      body: Consumer<SubcategoryProvider>(
        builder: (context, subcategoryProvider, child) {
          ...
          final subcategories = subcategoryProvider.getSubcategoriesBySection('الفقه');
            ...
            return Center(
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    'لا توجد فئات فرعية في قسم الفقه',
